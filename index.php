...
?>
  <tr>
    ...
    <td><?php echo $Result['Action'];?><a href = "remove.php"><button type="button" class="btn btn-warning">Remove</button></a>   <a href = "edit_form.php"><button type="button" class="btn btn-warning">Edit</button></a></td>
  </tr>
<?php
}
?>
